...
class Dashboard extends React.Component {
  ...
  render() {
    const { requests, loading, syncing, showHistory, showArchived, monthlyHistory, currentMonth, deleteConfirmId, editingEstimate, estimateInput, attachmentType, attachmentInput, imagePreview, editingCompletionDate, completionDateInput, editingPrioritizedEstimate, prioritizedEstimateInput, editingPreviewUrl, previewUrlInput, newAttachmentType, newAttachmentData } = this.state;
